...
import { getFile, incrementPage } from '../../redux/slices/file';
import CheckboxShowFile from './CheckboxShowFile';
const baseStyle = {
  flex: 1,
  display: 'flex',
...
export default function CheckboxUpload(props) {
  ...
  return (
    <div {...getRootProps({ style })}>
      ...
      <div className="listFile">
        <Row>
          {data.current.map((item, index) => <CheckboxShowFile key={index} item={item} />)}
        </Row>
      </div>
